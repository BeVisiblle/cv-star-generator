      ...
      <Card className="p-4 md:p-5">
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
            <Button variant="ghost" size="sm" onClick={() => setOpen(true)} className="justify-center">
            ...
            <Button variant="ghost" size="sm" onClick={() => setJobOpen(true)} className="justify-center">
