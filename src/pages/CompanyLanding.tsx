    ...
    <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen">
      <header className="fixed top-0 left-0 right-0 z-50">
        <nav className="mx-auto max-w-6xl px-6 pt-6">
          <div className="bg-white/90 backdrop-blur rounded-[24px] shadow-lg border px-5 py-3">
            <div className="flex items-center justify-between gap-3">
              <Link to="/" className="flex items-center gap-3">
                ...
                <span className="text-xl font-semibold tracking-tight">BeVisiblle</span>
              </Link>

              <nav className="hidden md:flex items-center gap-2">
                <Link to="/cv-generator" className="rounded-lg px-3.5 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                  Lebenslauf
                </Link>
                <a href="#community" className="rounded-lg px-3.5 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                  Community
                </a>
                <Link to="/company" className="rounded-lg px-3.5 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                  Unternehmen
                </Link>
                <Link to="/about" className="rounded-lg px-3.5 py-2 text-sm font-medium text-[#5170ff] hover:bg-blue-50">
                  Über uns
                </Link>
              </nav>

              <div className="flex items-center gap-2">
                <Link to="/auth" className="hidden lg:inline-flex rounded-lg px-3.5 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                  Login
                </Link>
                <Link
                  to="/company/onboarding"
                  className="hidden md:inline-flex rounded-full px-5 py-2 text-sm font-semibold text-white"
                  style={{ background: '#5170ff', boxShadow: '0 12px 30px rgba(81,112,255,0.35)' }}
                >
                  Jetzt registrieren
                </Link>
                <button
          ...
          <div
            className={`${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden mt-3 rounded-2xl border bg-white/95 shadow-lg px-5 py-4`}
          >
            ...
            <Link to="/company/onboarding" className="block py-2 text-gray-700 hover:text-gray-900">
              Jetzt registrieren
            </Link>
      ...
      <section className="relative pt-28 pb-16">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="relative mt-8 flex justify-center">
            <img src="/assets/company-mainhero.png" alt="Digitale Vernetzung zwischen Talenten und Unternehmen" className="max-w-5xl w-full h-auto object-contain" />
          </div>
        </div>
      </section>
