...
async function createTestJobsFixed() {
  console.log('🚀 Erstelle Test-Jobs mit korrekten UUIDs...');
  ...
  try {
    ...
    const testJobs = [
      ...
      },
      {
        ...
        company_id: companyId,
        description_md: 'Gestalte benutzerfreundliche Interfaces und verbessere die User Experience unserer Produkte. Du arbeitest eng mit dem Entwicklungsteam zusammen.',
        city: 'Hamburg',
        country: 'Deutschland',
        work_mode: 'office',
        employment_type: 'full_time',
