...
export function JobDetailHeader({
  ...
  return <div className="bg-background border-b">
      <div className="max-w-[1600px] mx-auto px-6 py-6">
        {/* Back Button */}
        <Button variant="ghost" size="sm" onClick={() => navigate('/company/jobs')} className="mb-4 -ml-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Button onClick={() => navigate(`/company/jobs/${job.id}/edit`)} className="w-full gap-2">
                <Edit className="h-4 w-4" />
                Bearbeiten
              </Button>
              <Button variant="outline" onClick={() => navigate(`/jobs/${job.id}`)} className="w-full gap-2">
