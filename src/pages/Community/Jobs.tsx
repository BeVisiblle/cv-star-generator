      ...
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-6">
          ...
          <div className="space-y-6">
            ...
            {isLoading ? <div className="text-center py-12">
                ...
                <div className="grid gap-4">
                  {paginatedJobs.map(job => <PublicJobCard key={job.id} job={job} onClick={() => setSelectedJob(job)} />)}
                </div>
                ...
                return <Button key={pageNum} variant={currentPage === pageNum ? "default" : "outline"} size="icon" onClick={() => setCurrentPage(pageNum)} className="w-10">
                          {pageNum}
                        </Button>;
              })}
          ...
          <div className="text-center py-16">
                ...
                {hasActiveFilters && <Button variant="outline" onClick={resetFilters}>
                    Filter zurücksetzen
                  </Button>}
              </div>)}
          </div>
