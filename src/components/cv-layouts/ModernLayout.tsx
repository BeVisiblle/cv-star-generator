    ...
    <div className={`max-w-4xl mx-auto bg-white shadow-2xl rounded-xl overflow-hidden ${className}`} data-cv-preview>
      ...
      >
        <div className="flex items-center gap-6">
          <ProfileImage profilbild={data.profilbild} size="lg" className="border-4 border-white/20" />
            ...
            <div>
              ...
              <div className="space-y-4">
                {data.schulbildung.map((schule, index) => (
                  <div key={index} className={`border-l-4 border-[hsl(${colors.primary})] pl-4 bg-[hsl(${colors.secondary})] p-4 rounded-r-lg`}>
