...
import { TrendingUp, Users, Award, Phone, Mail, MapPin, Calendar, Star, Target, Briefcase } from 'lucide-react';

const ServiceSalesLayout: React.FC<CVLayoutProps> = ({ data, className = '' }) => {
    ...
    <div className={cn("max-w-4xl mx-auto bg-white shadow-lg", className)} data-cv-preview>
      ...
      <div className="flex">
        ...
        <div className="w-[60%] p-6 space-y-6">
          ...
          {data.ueberMich && (
            <section>
              <h2 className="text-xl font-bold text-red-600 mb-3 flex items-center gap-2 border-b-2 border-red-200 pb-2">
              ...
              <div className="space-y-4">
                {data.berufserfahrung.map((job, index) => (
                  <div key={index} className="border-l-4 border-red-300 pl-4">
                    ...
                    <div className="text-red-600 font-medium mb-1">{job.unternehmen}, {job.ort}</div>
                    {job.beschreibung && (
              ...
              <div className="space-y-4">
                {data.schulbildung.map((edu, index) => (
                  <div key={index} className="border-l-4 border-red-300 pl-4">
                    ...
                    <div className="text-red-600 font-medium mb-1">{edu.name}, {edu.ort}</div>
                    {edu.beschreibung && (
        ...
        {/* Right Column - 40% */}
        <div className="w-[40%] bg-gray-50 p-6 space-y-6">
          {/* Skills */}
            ...
            <section>
              ...
              <div className="space-y-2">
                {data.faehigkeiten.map((skill, index) => (
                  <div key={index} className="bg-white p-2 rounded border-l-4 border-red-400 text-sm">
                    {skill}
                  </div>
                ))}
              </div>
          ...
          <section>
            ...
            <div className="bg-white p-3 rounded border-l-4 border-red-400">
              <div className="text-sm font-medium mb-2">Kundenorientierung</div>
              <div className="text-xs text-gray-600 mb-2">Hohe Kundenzufriedenheit</div>
              <div className="text-sm font-medium mb-2">Verkaufserfolg</div>
              <div className="text-xs text-gray-600">Zielerreichung übertroffen</div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-white p-3 rounded border-l-4 border-red-400">
              ...
              <div className="text-xs text-gray-600 mt-1">Flexible Arbeitszeiten</div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-white p-3 rounded border-l-4 border-red-400">
              <div className="text-sm font-medium">Erreichbarkeit</div>
              <div className="text-xs text-gray-600">Mo-Fr: 8:00-18:00</div>
              <div className="text-xs text-gray-600">Sa: 9:00-14:00</div>
            </div>
          </section>
        </div>
      </div>
...
export default ServiceSalesLayout;