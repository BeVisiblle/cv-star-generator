...
import { LayoutDashboard, Users, Building2, BadgePercent, Briefcase, HeartHandshake, BarChart3, FileText, LifeBuoy, Settings, Wrench } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const navItems: ReadonlyArray<NavItem> = [
  ...
  { title: "Benutzer", url: "/admin/users", icon: Users, roles: ["SuperAdmin", "SupportAgent", "ContentEditor"] },
  { title: "Unternehmen", url: "/admin/companies", icon: Building2, roles: ["SuperAdmin", "SupportAgent", "CompanyAdmin", "ContentEditor"] },
