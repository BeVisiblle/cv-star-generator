...
async function insertTestJobs() {
  try {
    console.log('🚀 Starte das Einfügen der Test-Jobs...');
    ...
    if (company1Error) {
      console.log('Company 1 bereits vorhanden oder Fehler:', company1Error.message);
    } else {
      console.log('✅ Company 1 erstellt');
    }
    ...
    if (company2Error) {
      console.log('Company 2 bereits vorhanden oder Fehler:', company2Error.message);
    } else {
      console.log('✅ Company 2 erstellt');
    }
    ...
    console.log('🎉 Alle Test-Jobs wurden erfolgreich erstellt!');
    ...
    console.error('❌ Fehler beim Erstellen der Test-Jobs:', error);
  }
}
