...
import { MapPin, Building, Clock, Euro, Users, Calendar, Edit, ArrowLeft } from 'lucide-react';
...
export default function JobCompanyView({ jobId: propJobId }: JobCompanyViewProps) {
  ...
  const handleEdit = () => {
    // TODO: Navigate to job editing
    console.log('Edit job:', jobId);
    toast({
      title: 'Bearbeitung',
      description: 'Job-Bearbeitung wird implementiert.',
    });
  };
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <Badge variant={job.is_public ? "default" : "outline"}>
                {job.is_public ? "Öffentlich" : "Privat"}
              </Badge>
              {job.is_draft && (
