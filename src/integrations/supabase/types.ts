  ...
  public: {
    Tables: {
      ...
      company_follows: {
        ...
        Relationships: [
          {
            foreignKeyName: "company_follows_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      post_comments: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "posts_with_engagement"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      auto_freeze_unverified_companies: { Args: never; Returns: undefined }
      bulk_stage_update: {
        Args: {
          p_company_id: string
          p_note?: string
      ...
      ensure_company_wallet: { Args: { p_company_id: string }; Returns: string }
      ensure_job_slug: { Args: { p_job: string }; Returns: string }
      ...
      fix_company_user_metadata: { Args: never; Returns: undefined }
      ...
      increment_login_count: { Args: { user_id: string }; Returns: number }
      is_company_admin: { Args: { _company_id: string }; Returns: boolean }
      is_company_member: { Args: never; Returns: boolean }
      is_company_member_uid: { Args: { _uid: string }; Returns: boolean }
      is_company_user: { Args: never; Returns: boolean }
      is_connected: { Args: { _u1: string; _u2: string }; Returns: boolean }
      is_content_editor: { Args: { _uid?: string }; Returns: boolean }
      ...
      refill_monthly_tokens: { Args: never; Returns: undefined }
      resolve_location_id: {
      ...
      share_community_post:
        | {
            Args: { p_post_id: string; p_sharer_user_id: string }
            Returns: {
              share_count: number
              shared: boolean
            }[]
