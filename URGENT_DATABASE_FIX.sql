-- URGENT: Execute this SQL directly in Supabase SQL Editor
-- This will fix the missing driving_licenses column error
...
AND column_name IN ('driving_licenses', 'skills', 'languages', 'certifications')
